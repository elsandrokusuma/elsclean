...
export default function BlogPreview() {
  ...
  return (
    <section id="blog" className="w-full py-12 md:pt-8 md:pb-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        {loading ? (
          ...
          <div className="mx-auto grid grid-cols-1 gap-6 pt-5 md:pt-12 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl">
            {blogPosts.map((post) => (
